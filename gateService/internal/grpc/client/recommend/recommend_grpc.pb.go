...
const (
	RecommendService_ListRecommendations_FullMethodName = "/recommend.RecommendService/ListRecommendations"
)
...
type RecommendServiceClient interface {
	ListRecommendations(ctx context.Context, in *RecommendationRequest, opts ...grpc.CallOption) (*RecommendationResponseList, error)
}
...
func (c *recommendServiceClient) ListRecommendations(ctx context.Context, in *RecommendationRequest, opts ...grpc.CallOption) (*RecommendationResponseList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RecommendationResponseList)
	err := c.cc.Invoke(ctx, RecommendService_ListRecommendations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecommendServiceServer interface {
	ListRecommendations(context.Context, *RecommendationRequest) (*RecommendationResponseList, error)
...
func (UnimplementedRecommendServiceServer) ListRecommendations(context.Context, *RecommendationRequest) (*RecommendationResponseList, error) {
...
func _RecommendService_ListRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecommendationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendServiceServer).ListRecommendations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendService_ListRecommendations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendServiceServer).ListRecommendations(ctx, req.(*RecommendationRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RecommendService_ListRecommendations_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/grpc/proto/recommend.proto",
}
